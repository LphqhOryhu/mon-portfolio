...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [CommonModule, DocumentComponent,RouterOutlet, BreadcrumbComponent, HeaderComponent, MainContentComponent, SidebarComponent, StageComponent, VeilleComponent, CompetencesComponent, ScrollToTopComponent],
